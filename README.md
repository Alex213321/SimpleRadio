...
> 当前版本：**1.4.2**。本仓库公开完整程序源码、构建脚本和测试；大体积音乐与高清壁纸通过 Release 分发，不放进 Git 历史。**[下载 v1.4.2 成品](https://github.com/Alex213321/SimpleRadio/releases/tag/v1.4.2)：请同时下载 Program 和 Music 两个 ZIP，按下方教程合并解压。**
